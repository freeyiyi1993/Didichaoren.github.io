...
$(document).ready(function(){
    ...
    $('nav').find('.form input.input-lg').parents(".form").css({"margin-top":((50 - height4)/2)+"px","margin-bottom":((50 - height4)/2)+"px"});
    ...
    $('nav').find('.form input.input-sm').parents(".form").css({"margin-top":((50 - height2)/2)+"px","margin-bottom":((50 - height2)/2)+"px"});
